...
namespace Frontend.Controllers
{
    public class StatisticsController : Controller
    {
        ...
        private static string API_VALUES_ROUTE = "/api/statistic/";
        private static string API_VALUES_RANK_ROUTE = "/api/values/rank/";
        private static string TEXT_DETAILS_ROUTE = "/Home/TextStatistic/";
        ...
        public IActionResult TextStatistic(string id)
        {
        ...
        public IActionResult Upload(string message, string location)
        {
            ...
            var response = client.PostAsJsonAsync(url, message);
